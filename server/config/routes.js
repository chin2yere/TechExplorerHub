...
router.get(
  "/companys/:constraint/:value",
  route_functions.getCompanysByConstraint
);
router.get(
  "/company/:constraint/:value",
  route_functions.getCompanyByConstraint
);
...
//everything jobs
router.get("/jobs", route_functions.getJobs);
router.get("/jobs/:constraint/:value", route_functions.getJobsByConstraint);
router.get("/job/:constraint/:value", route_functions.getJobByConstraint);
router.post("/job", route_functions.createJob);
router.patch("/job/:id", route_functions.updateJob);
router.delete("/job", route_functions.deleteJob);
